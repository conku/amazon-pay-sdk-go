...
After placed orders, you can manage them via [our admin interface]((https://demo.getqor.com/admin)), like `take auth`, `capture`, `refund` orders, the admin interface is generated with [QOR Admin](http://github.com/conku/admin)

#### Source code of this demo

[https://github.com/conku/qor-example](https://github.com/conku/qor-example)
